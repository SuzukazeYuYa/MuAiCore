local tbl = 
{
				...
				
				{
					data = 
					{
						...
						conditions = 
						{
							...
							{
								"e9cd65d2-8ce2-9094-a9a0-9f3fde648f25",
								true,
							},
						},
						gVar = "ACR_TensorViper3_CD",
						name = "清空11S缓存",
						uuid = "b28e2d8f-9b06-1d01-b6ba-470994881955",
						version = 2.1,
					},
					inheritedIndex = 1,
				},
				
				{
					data = 
					{
						...
						conditions = 
						{
							...
							{
								"7e65af4d-6699-0c47-819b-bba2ad62f686",
								true,
							},
						},
						gVar = "ACR_TensorViper3_CD",
						name = "清空12S缓存",
						uuid = "e284d169-ec31-5c68-ad0b-ac36a4cb9df6",
						version = 2.1,
					},
				},
			},
				...
				
				{
					data = 
					{
						...
						conditions = 
						{
							...
							{
								"779fc96c-7e91-aacd-93bd-84ed131e406b",
								true,
							},
						},
			...
			conditions = 
			{
				...
				
				{
					data = 
					{
						...
						name = "M11S已初始化",
						uuid = "779fc96c-7e91-aacd-93bd-84ed131e406b",
						version = 3,
					},
					inheritedIndex = 4,
				},
		...
		data = 
		{
			actions = 
			{
				
				{
					...
					{
						aType = "Lua",
						actionLua = "if data.lastState == nil or data.lastState ~=  MuAiGuide.M11S.CurrentState then\n\tdata.lastState = MuAiGuide.M11S.CurrentState\n\td(\"当前进度：\" .. tostring(MuAiGuide.M11S.CurrentState))\nend\nself.used = true",
						conditions = 
						{
							
							{
								"37a950fd-cffd-5a07-9d99-30a2f34235cc",
								true,
							},
							
							{
								"723d1fca-2c1f-9390-872d-6ca83eb320ac",
								true,
							},
						},
						gVar = "ACR_RikuMNK3_CD",
						name = "m11s_debug",
						uuid = "bb146fdb-c962-fa55-98d8-1cfdbbd5702a",
						version = 2.1,
					},
					inheritedIndex = 1,
				},
			...
			conditions = 
			{
				...
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return MuAiGuide.M12S ~= nil and MuAiGuide.M12S.CurrentState ~= nil",
						name = "M12S已初始化",
				...
				
				{
					data = 
					{
						...
						localmapid = 1325,
						name = "M11S",
						uuid = "37a950fd-cffd-5a07-9d99-30a2f34235cc",
						version = 3,
					},
				},
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return MuAiGuide.M11S ~= nil and MuAiGuide.M11S.CurrentState ~= nil",
						name = "M11S已初始化",
						uuid = "723d1fca-2c1f-9390-872d-6ca83eb320ac",
						version = 3,
					},
					inheritedIndex = 2,
				},
	...
	
	{
		data = 
		{
			...
			enabled = false,
			name = "-------  m9s  --------",
			uuid = "de52df49-7491-2d3a-8514-e28783d15762",
			version = 2,
		},
		inheritedIndex = 6,
	},
		...
		data = 
		{
			actions = 
			{
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local player = TensorCore.mGetPlayer()\nlocal party = MuAiGuide.GetPartyPlayers()\nlocal drawerDanger = TensorCore.getStaticDrawer(GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2), 1)\nlocal drawerSafe = TensorCore.getStaticDrawer(GUI:ColorConvertFloat4ToU32(0, 1, 0, 0), 3)\nfor _, ent in pairs(party) do\n    if ent.id ~= player.id then\n        local neekCheck = (TensorCore.hasBuff(player.id, 4729) and (TensorCore.hasBuff(ent.id, 4729) or TensorCore.hasBuff(ent.id, 2941)))\n                or (TensorCore.hasBuff(player.id, 2941) and TensorCore.hasBuff(ent.id, 4729))\n        if neekCheck then\n            local curEnt = TensorCore.mGetEntity(ent.id)\n            local distance = TensorCore.getDistance2d(player.pos, curEnt.pos)\n            if distance < 8 then\n                drawerDanger:addCircle(curEnt.pos.x, curEnt.pos.y, curEnt.pos.z, 8)\n            else\n                drawerSafe:addCircle(curEnt.pos.x, curEnt.pos.y, curEnt.pos.z, 8)\n            end\n        end\n    end\nend \nself.used = true\n",
						conditions = 
						{
							
							{
								"6d38041c-46c5-8834-9909-d567690dccb5",
								true,
							},
							
							{
								"ecf13ff3-220b-25e5-86e1-bc032b929388",
								true,
							},
						},
						gVar = "ACR_RikuMNK3_CD",
						name = "画出是否处于他人范围",
						uuid = "af653061-fb6b-d6e2-86bd-71e7eb6347a0",
						version = 2.1,
					},
					inheritedIndex = 1,
				},
			...
			conditions = 
			{
				
				{
					data = 
					{
						...
						localmapid = 1321,
						name = "M9S",
						uuid = "6d38041c-46c5-8834-9909-d567690dccb5",
						version = 3,
					},
				},
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return data ~= nil and data.MuAiM9STimer ~= nil \nand TimeSince(data.MuAiM9STimer) < 25000 and TimeSince(data.MuAiM9STimer) > 5000\nand (TensorCore.hasBuff(TensorCore.mGetPlayer().id, 4729) or TensorCore.hasBuff(TensorCore.mGetPlayer().id, 2941))",
						name = "蝙蝠机制中",
						uuid = "ecf13ff3-220b-25e5-86e1-bc032b929388",
						version = 3,
					},
				},
			},
			...
			eventType = 12,
			name = "M9S-臭蝙蝠",
			uuid = "8e56c349-5610-6a79-89e1-076f5a6fdf4e",
			version = 2,
		},
		inheritedIndex = 7,
	},
		...
		data = 
		{
			actions = 
			{
				
				{
					...
					{
						aType = "Lua",
						actionLua = "data.MuAiM9STimer = Now()\nself.used = true",
						conditions = 
						{
							
							{
								"465cabbf-1086-3401-9f0c-098a0a472c2d",
								true,
							},
							
							{
								"6dda545c-b779-3e4b-8f78-0614c04a5b10",
								true,
							},
						},
						gVar = "ACR_RikuMNK3_CD",
						uuid = "6807bf89-d46e-1c5d-836a-93a2dfdd25a0",
						version = 2.1,
					},
				},
			},
			conditions = 
			{
				
				{
					data = 
					{
						...
						localmapid = 1321,
						name = "M9S",
						uuid = "465cabbf-1086-3401-9f0c-098a0a472c2d",
						version = 3,
					},
				},
				
				{
					data = 
					{
						...
						eventSpellID = 45898,
						name = "45898-血魅的靴踏音",
						uuid = "6dda545c-b779-3e4b-8f78-0614c04a5b10",
						version = 3,
					},
				},
			},
		...
		data = 
		{
			actions = 
			{
				
				{
					...
					{
						aType = "Lua",
						actionLua = "MuAiGuide.M11S.CurrentBoss = TensorCore.mGetTarget()\nself.used = true",
						conditions = 
						{
			...
			conditions = 
			{
				...
				
				{
					...
					{
						category = "Lua",
						conditionLua = "local target = TensorCore.mGetTarget()\nreturn target ~= nil\n\tand target.attackable\n\tand (MuAiGuide.M11S.CurrentBoss == nil or MuAiGuide.M11S.CurrentBoss.id ~= target.id)",
						conditionType = 5,
						name = "当前BOSS为空或者目标变化",
		...
		data = 
		{
			actions = 
			{
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nif table.size(M.M11S.OrbitalOmen.Pair) < 2 then\n    table.insert(M.M11S.OrbitalOmen.Pair, eventArgs.a1)\n    if table.size(M.M11S.OrbitalOmen.Pair) == 2 then\n        table.sort(M.M11S.OrbitalOmen.Pair, function(a, b)\n            return a < b\n        end)\n        table.insert(M.M11S.OrbitalOmen.Data, { cross = M.M11S.OrbitalOmen.Pair, time = Now() })\n        M.M11S.OrbitalOmen.Pair = {}\n    end\nend\n-- 2条线出现即可进行指路分析\nif table.size(M.M11S.OrbitalOmen.Data) == 2 then\n    -- 分析1的情况\n    local cross1 = M.M11S.OrbitalOmen.Data[1].cross\n    local cross2 = M.M11S.OrbitalOmen.Data[2].cross\n    local player = M.GetPlayer()\n    local guidePos1, guidePos2, guidePos3\n    if M.Config.Main.M11SOrbitalOmenAllMelee or M.IsMelee(player.job) or M.IsTank(player.job) then\n        local spawnType\n        -- 近战采取阿洛攻略方案\n        for _, c1Pos in pairs(M.M11S.OrbitalOmen.Mid) do\n            if M.M11S.OrbitalOmen.IsSame(cross1, c1Pos) then\n                spawnType = 1\n                break\n            end\n        end\n        if spawnType == nil then\n            for _, c1Pos in pairs(M.M11S.OrbitalOmen.Corner) do\n                if M.M11S.OrbitalOmen.IsSame(cross1, c1Pos) then\n                    spawnType = 2\n                    break\n                end\n            end\n        end\n        if spawnType == nil then\n            for _, c1Pos in pairs(M.M11S.OrbitalOmen.Edge) do\n                if M.M11S.OrbitalOmen.IsSame(cross1, c1Pos) then\n                    spawnType = 3\n                    break\n                end\n            end\n        end\n        M.M11S.OrbitalOmen.guideType = spawnType\n        if spawnType == 1 then\n            if M.M11S.OrbitalOmen.IsSame(cross1, { 3, 7 }) then\n                guidePos1 = { x = 101, z = 100.4 }\n                guidePos2 = { x = 99.5, z = 99.5 }\n            elseif M.M11S.OrbitalOmen.IsSame(cross1, { 4, 8 }) then\n                guidePos1 = { x = 99, z = 99.6 }\n                guidePos2 = { x = 100.5, z = 100.5 }\n            elseif M.M11S.OrbitalOmen.IsSame(cross1, { 3, 8 }) then\n                guidePos1 = { x = 101, z = 99.6 }\n                guidePos2 = { x = 99.5, z = 100.5 }\n            elseif M.M11S.OrbitalOmen.IsSame(cross1, { 4, 7 }) then\n                guidePos1 = { x = 99, z = 100.4 }\n                guidePos2 = { x = 100.5, z = 99.5 }\n            end\n        elseif spawnType == 2 then\n            if M.M11S.OrbitalOmen.IsSame(cross2, { 3, 7 }) then\n                guidePos1 = { x = 101, z = 100.4 }\n                guidePos2 = { x = 100.5, z = 100.5 }\n                guidePos3 = { x = 99.5, z = 99.5 }\n            elseif M.M11S.OrbitalOmen.IsSame(cross2, { 4, 8 }) then\n                guidePos1 = { x = 99, z = 99.6 }\n                guidePos2 = { x = 99.5, z = 99.5 }\n                guidePos3 = { x = 100.5, z = 100.5 }\n            elseif M.M11S.OrbitalOmen.IsSame(cross2, { 3, 8 }) then\n                guidePos1 = { x = 101, z = 99.6 }\n                guidePos2 = { x = 100.5, z = 99.5 }\n                guidePos3 = { x = 99.5, z = 100.5 }\n            elseif M.M11S.OrbitalOmen.IsSame(cross2, { 4, 7 }) then\n                guidePos1 = { x = 99, z = 100.4 }\n                guidePos2 = { x = 99.5, z = 100.5 }\n                guidePos3 = { x = 100.5, z = 99.5 }\n            end\n        elseif spawnType == 3 then\n            if M.M11S.OrbitalOmen.IsSame(cross2, { 3, 7 }) then\n                guidePos1 = { x = 99, z = 99.6 }\n                guidePos2 = { x = 100.5, z = 100.5 }\n                guidePos3 = { x = 99.5, z = 99.5 }\n            elseif M.M11S.OrbitalOmen.IsSame(cross2, { 4, 8 }) then\n                guidePos1 = { x = 101, z = 100.4 }\n                guidePos2 = { x = 99.5, z = 99.5 }\n                guidePos3 = { x = 100.5, z = 100.5 }\n            elseif M.M11S.OrbitalOmen.IsSame(cross2, { 3, 8 }) then\n                guidePos1 = { x = 99, z = 100.4 }\n                guidePos2 = { x = 100.5, z = 99.5 }\n                guidePos3 = { x = 99.5, z = 100.5 }\n            elseif M.M11S.OrbitalOmen.IsSame(cross2, { 4, 7 }) then\n                guidePos1 = { x = 101, z = 99.6 }\n                guidePos2 = { x = 99.5, z = 100.5 }\n                guidePos3 = { x = 100.5, z = 99.5 }\n            end\n        end\n    else\n        M.M11S.OrbitalOmen.guideType = 4\n        --如果是远程，直接采取一步法\n        ----------------------- 第1行 -----------------------\n        if M.M11S.OrbitalOmen.IsSame(cross1, { 2, 6 }) then\n            guidePos1 = { x = 90.4, z = 91 }\n            guidePos2 = { x = 89.5, z = 89.5 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 3, 6 }) then\n            guidePos1 = { x = 89, z = 91 }\n            guidePos2 = { x = 91, z = 89 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 4, 6 }) then\n            guidePos1 = { x = 111, z = 91 }\n            guidePos2 = { x = 109, z = 89 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 5, 6 }) then\n            guidePos1 = { x = 109.6, z = 91 }\n            guidePos2 = { x = 111, z = 89 }\n            ----------------------- 第2行 -----------------------\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 2, 7 }) then\n            guidePos1 = { x = 91, z = 101 }\n            guidePos2 = { x = 89, z = 99 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 3, 7 }) then\n            guidePos1 = { x = 89, z = 101 }\n            guidePos2 = { x = 91, z = 99 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 4, 7 }) then\n            guidePos1 = { x = 111, z = 101 }\n            guidePos2 = { x = 109, z = 99 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 5, 7 }) then\n            guidePos1 = { x = 109, z = 101 }\n            guidePos2 = { x = 111, z = 99 }\n            ----------------------- 第3行 -----------------------\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 2, 8 }) then\n            guidePos1 = { x = 91, z = 99 }\n            guidePos2 = { x = 89, z = 101 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 3, 8 }) then\n            guidePos1 = { x = 89, z = 99 }\n            guidePos2 = { x = 91, z = 101 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 4, 8 }) then\n            guidePos1 = { x = 111, z = 99 }\n            guidePos2 = { x = 109, z = 101 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 5, 8 }) then\n            guidePos1 = { x = 109, z = 99 }\n            guidePos2 = { x = 111, z = 101 }\n            ----------------------- 第4行 -----------------------\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 2, 9 }) then\n            guidePos1 = { x = 90.4, z = 109 }\n            guidePos2 = { x = 89, z = 111 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 3, 9 }) then\n            guidePos1 = { x = 89, z = 109 }\n            guidePos2 = { x = 91, z = 111 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 4, 9 }) then\n            guidePos1 = { x = 111, z = 109 }\n            guidePos2 = { x = 109, z = 111 }\n        elseif M.M11S.OrbitalOmen.IsSame(cross1, { 5, 9 }) then\n            guidePos1 = { x = 109.6, z = 109 }\n            guidePos2 = { x = 111, z = 111 }\n        end\n    end\n    M.M11S.OrbitalOmen.GuidePos = { guidePos1, guidePos2, guidePos3 }\nend\nself.used = true",
						conditions = 
						{
							...
							{
								"fa6fe897-d10d-97a1-9d9c-251558105853",
								true,
							},
						},
						gVar = "ACR_TensorViper3_CD",
						name = "星轨链-数据采集",
						uuid = "51e44c1c-fe7a-744a-b727-f2ff3003503f",
						version = 2.1,
					},
					inheritedIndex = 1,
				},
				...
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nif eventArgs.a2 == 4 then\n    M.M11S.Meteor2MapEffect = nil\nelseif eventArgs.a2 == 16 then\n    if M.M11S.Meteor2MapEffect == nil then\n        M.M11S.Meteor2MapEffect = {}\n    end\n    table.insert(M.M11S.Meteor2MapEffect, eventArgs.a1)\n    if M.M11S.CurrentState == M.M11S.State.Meteor2_Debuff1 then\n        M.M11S.CurrentState = M.M11S.State.Meteor2_Link2\n    end\nend\nself.used = true",
						conditions = 
						{
						...
						name = "王者陨石-半场刀",
						uuid = "df56c109-489a-f42e-af38-81699e705bf0",
						version = 2.1,
					},
					inheritedIndex = 2,
				},
			...
			conditions = 
			{
				...
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return 2 <= eventArgs.a1 and eventArgs.a1 <= 9 and eventArgs.a2 == 1",
						name = "星轨链",
						uuid = "fa6fe897-d10d-97a1-9d9c-251558105853",
						version = 3,
					},
				},
			},
		...
		data = 
		{
			actions = 
			{
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nif M.M11S.Meteor2Gather == nil then\n    M.M11S.Meteor2Gather = {}\nend\n\nif table.size(M.M11S.Meteor2Gather) < 2 then\n    table.insert(M.M11S.Meteor2Gather, eventArgs.entityID)\n    if table.size(M.M11S.Meteor2Gather) == 2 then\n        local player = M.GetPlayer()\n        for _, id in pairs(M.M11S.Meteor2Gather) do\n            local curHealer = TensorCore.mGetEntity(id)\n            if curHealer.pos.x > 100 and player.pos.x > 100\n                    or curHealer.pos.x < 100 and player.pos.x < 100\n            then\n                M.M11S.Meteor2GatherPartnerId = id\n                M.M11S.CurrentState = M.M11S.State.Meteor2_GatherMark\n            end\n        end\n    end\nend\nself.used = true",
						conditions = 
						{
							...
							{
								"551c95b8-9b55-2da2-b99d-1d4b88347760",
								true,
							},
							
							{
								"7b99f9cf-0d4f-f10e-8478-01f39e54232e",
								true,
							},
						},
						gVar = "ACR_TensorWeeb3_CD",
						name = "王者陨石-点名分摊",
						uuid = "28895952-675b-89ea-83a1-862e0a108e23",
						version = 2.1,
					},
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nif M.M11S.Meteor2Marks == nil then\n    M.M11S.Meteor2Marks = {}\nend\ntable.insert(M.M11S.Meteor2Marks, eventArgs.entityID)\nif table.size(M.M11S.Meteor2Marks) == 4 then\n    if M.M11S.CurrentState < M.M11S.State.Meteor2_GetMark1 then\n        M.M11S.CurrentState = M.M11S.State.Meteor2_GetMark1\n    elseif M.M11S.CurrentState < M.M11S.State.Meteor2_GetMark2 then\n        M.M11S.CurrentState = M.M11S.State.Meteor2_GetMark2\n    end\n    M.M11S.GetMarkTime = Now()\nend\nself.used = true",
						conditions = 
						{
						...
						gVar = "ACR_TensorWeeb3_CD",
						name = "王者陨石-火焰点名",
						uuid = "e32e8973-f3b4-5ef4-bee5-101725e29f84",
						version = 2.1,
					},
					inheritedIndex = 3,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nif M.M11S.Meteor3Info.Marked == nil then\n    M.M11S.Meteor3Info.Marked = {}\nend\ntable.insert(M.M11S.Meteor3Info.Marked, eventArgs.entityID)\nself.used = true",
						conditions = 
						{
						...
						gVar = "ACR_RikuMNK3_CD",
						name = "陨石狂奔-被点名放圈",
						uuid = "ab24f600-dcd0-892f-8dd2-f4338cf3946d",
						version = 2.1,
					},
					inheritedIndex = 3,
				},
			...
			conditions = 
			{
				...
				
				{
					data = 
					{
						...
						eventMarkerID = 244,
						name = "灵星雨|王者陨石-点名标记",
						uuid = "dc0ab7b8-c12b-fa25-ad8b-0a36d5956a66",
						version = 3,
					},
				},
				
				{
					data = 
					{
						...
						eventMarkerID = 525,
						name = "流星雨-分摊标记",
						uuid = "d5e4eff2-a633-fe5c-80b8-cef49373c5b6",
						version = 3,
					},
				},
				
				{
					data = 
					{
						...
						eventMarkerID = 305,
						name = "王者陨石-分摊标记",
						uuid = "551c95b8-9b55-2da2-b99d-1d4b88347760",
						version = 3,
					},
					inheritedIndex = 5,
				},
				...
				
				{
					data = 
					{
						...
						name = "王者陨石阶段",
						uuid = "7b99f9cf-0d4f-f10e-8478-01f39e54232e",
						version = 3,
					},
				},
		...
		data = 
		{
			actions = 
			{
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nif M.M11S.Meteor3Info.boom == nil then\n    M.M11S.Meteor3Info.boom = {}\nend\n\nif table.size(M.M11S.Meteor3Info.boom) < 2 then\n    table.insert(M.M11S.Meteor3Info.boom,\n            {\n                id = eventArgs.entityID,\n                pos = { x = eventArgs.x, y = eventArgs.y, z = eventArgs.z }\n            }\n    )\n    if table.size(M.M11S.Meteor3Info.boom) == 2 then\n        M.M11S.Meteor3Info.BoomTime = Now()\n        M.M11S.CurrentState = M.M11S.State.Meteor3_Guide1\n    end\nend\nself.used = true",
						conditions = 
						{
							
							{
								"cb8fa7cb-c8df-d4e2-a37f-5fc6c6a4dde7",
								true,
							},
							
							{
								"7f0a8c25-150d-aa63-ade1-68e904d5be9e",
								true,
							},
						},
						name = "距离衰减",
						uuid = "736f0b69-f92b-b531-9301-cea7bfcc21bd",
						version = 2.1,
					},
				},
			},
			conditions = 
			{
				
				{
					data = 
					{
						...
						localmapid = 1325,
						name = "M11S",
						uuid = "cb8fa7cb-c8df-d4e2-a37f-5fc6c6a4dde7",
						version = 3,
					},
					inheritedIndex = 1,
				},
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return eventArgs.aoeID == 46163",
						name = "aoeId=46163",
						uuid = "7f0a8c25-150d-aa63-ade1-68e904d5be9e",
						version = 3,
					},
				},
			},
			eventType = 18,
			name = "M11S-onAOECreate",
			uuid = "8359f828-1e0f-c707-9296-77733126c18b",
			version = 2,
		},
		inheritedIndex = 15,
	},
		...
		data = 
		{
			actions = 
			{
				...
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nif M.M11S.CurrentState == M.M11S.State.Weapon1_Start then\n    if M.M11S.WeaponInfo == nil or table.size(M.M11S.WeaponInfo.ordered) < 3 then\n        M.M11S.OrderWeapon()\n    elseif table.size(M.M11S.WeaponInfo.ordered) == 3 then\n        M.M11S.TakeWeapon(1, M.M11S.State.Weapon1_01)\n    end\nend\n\nif M.M11S.CurrentState == M.M11S.State.Weapon1_01 then\n    M.M11S.TakeWeapon(2, M.M11S.State.Weapon1_02)\nend\n\nif M.M11S.CurrentState == M.M11S.State.Weapon1_02 then\n    M.M11S.TakeWeapon(3, M.M11S.State.Weapon1_03)\nend\n\nif M.M11S.CurrentState == M.M11S.State.Weapon1_03 then\n    M.M11S.CurrentState = M.M11S.State.Weapon1_End\n    M.M11S.WeaponInfo = nil\nend\n\nif M.M11S.CurrentState == M.M11S.State.Weapon2_Start then\n    if M.M11S.WeaponInfo == nil or table.size(M.M11S.WeaponInfo.ordered) < 3 then\n        M.M11S.OrderWeapon()\n    elseif table.size(M.M11S.WeaponInfo.ordered) == 3 then\n        if M.M11S.CurrentState == M.M11S.State.Weapon2_Start then\n            if M.M11S.WeaponInfo.DrawStartTime == nil then\n                M.M11S.WeaponInfo.DrawStartTime = Now() + 2000\n            end\n            M.M11S.TakeWeapon(1, M.M11S.State.Weapon2_01, M.M11S.WeaponInfo.DrawStartTime  )\n        else\n            M.M11S.TakeWeapon(1, M.M11S.State.Weapon2_01)\n        end\n    end\nend\n\nif M.M11S.CurrentState == M.M11S.State.Weapon2_01 then\n    M.M11S.TakeWeapon(2, M.M11S.State.Weapon2_02)\nend\n\nif M.M11S.CurrentState == M.M11S.State.Weapon2_02 then\n    M.M11S.TakeWeapon(3, M.M11S.State.Weapon2_03)\nend\n\nif M.M11S.CurrentState == M.M11S.State.Weapon2_03 then\n    M.M11S.CurrentState = M.M11S.State.Weapon2_End\n    M.M11S.WeaponInfo = nil\n    M.M11S.InitWeapon()\nend\n\nif M.M11S.CurrentState >= M.M11S.State.Weapon3_Start and M.M11S.CurrentState < M.M11S.State.Weapon3_End then\n    for _, ent in pairs(TensorCore.entityList(\"contentid=108\")) do\n        if Argus.isEntityVisible(ent)\n                and (not table.contains(M.M11S.WeaponInfo.ids, ent.id))\n                and (M.M11S.WeaponInfo.CurrentWeaponId == nil or ent.id ~= M.M11S.WeaponInfo.CurrentWeaponId)\n        then\n            local md = Argus.getEntityModel(ent.id)\n            if (md == 19184 or md == 19185 or md == 19186)\n            then\n                table.insert(M.M11S.WeaponInfo.ids, ent.id)\n            end\n        end\n    end\nend\n\nfor state = M.M11S.State.Weapon3_Start, M.M11S.State.Weapon3_Start + 5 do\n    if M.M11S.CurrentState == state then\n        local nextState = state + 1\n        M.M11S.TakeExWeapon(nextState)\n        break\n    end\nend\n\nif M.M11S.CurrentState == M.M11S.State.Weapon3_06 then\n    if M.M11S.WeaponInfo.Winds == nil then\n        M.M11S.WeaponInfo.Winds = {}\n        M.M11S.WeaponInfo.WindTime = Now()\n    end\n    if table.size(M.M11S.WeaponInfo.Winds) < 4 then\n        for _, ent in pairs(TensorCore.entityList(\"contentid=14307\")) do\n            if Argus.isEntityVisible(ent)\n                    and (not table.contains(M.M11S.WeaponInfo.Winds, ent.id))\n            then\n                table.insert(M.M11S.WeaponInfo.Winds, ent.id)\n            end\n        end\n        if table.size(M.M11S.WeaponInfo.Winds) == 4 then\n            local dirWinds = {}\n            for _, id in pairs(M.M11S.WeaponInfo.Winds) do\n                local curWind = TensorCore.mGetEntity(id)\n                if curWind.pos.z < 95 then\n                    dirWinds.up = curWind\n                elseif curWind.pos.x < 95 then\n                    dirWinds.left = curWind\n                elseif curWind.pos.z > 105 then\n                    dirWinds.down = curWind\n                else\n                    dirWinds.right = curWind\n                end\n            end\n            local guideWind\n            if M.SelfPos == \"MT\" or M.SelfPos == \"D1\" then\n                guideWind = dirWinds.up\n            elseif M.SelfPos == \"ST\" or M.SelfPos == \"D2\" then\n                guideWind = dirWinds.down\n            elseif M.SelfPos == \"H1\" or M.SelfPos == \"D3\" then\n                guideWind = dirWinds.left\n            elseif M.SelfPos == \"H2\" or M.SelfPos == \"D4\" then\n                guideWind = dirWinds.right\n            end\n            local dir = TensorCore.getHeadingToTarget({ x = 100, y = 0, z = 100 }, guideWind.pos)\n            if table.contains({ \"D1\", \"D2\", \"D3\", \"D4\" }, M.SelfPos) then\n                M.M11S.WeaponInfo.GuidePos = TensorCore.getPosInDirection(guideWind.pos, dir + math.pi / 4, 6.5)\n            else\n                M.M11S.WeaponInfo.GuidePos = TensorCore.getPosInDirection(guideWind.pos, dir - math.pi / 4, 6.5)\n            end\n        end\n    end\n    local changeState = false\n    for _, player in pairs(M.Party) do\n        local debuff = TensorCore.getBuff(player.id, 2941)\n        if debuff ~= nil then\n            changeState = true\n        end\n    end\n    if changeState then\n        M.M11S.CurrentState = M.M11S.State.Weapon3_End\n        M.DirectTo(100, 100, 5000)\n    elseif M.M11S.WeaponInfo.GuidePos ~= nil then\n        if M.Config.Main.M11SExDraw\n                and table.size(M.M11S.WeaponInfo.Winds) == 4\n                and TimeSince(M.M11S.WeaponInfo.WindTime) > 3000\n        then\n            for _, id in pairs(M.M11S.WeaponInfo.Winds) do\n                local wind = TensorCore.mGetEntity(id)\n                local nearest = {\n                    TensorCore.mGetEntity(M.Party[\"MT\"].id),\n                    TensorCore.mGetEntity(M.Party[\"ST\"].id),\n                }\n\n                local distances = {\n                    TensorCore.getDistance2d(wind.pos, nearest[1].pos),\n                    TensorCore.getDistance2d(wind.pos, nearest[2].pos)\n                }\n\n                if distances[1] > distances[2] then\n                    nearest[1], nearest[2] = nearest[2], nearest[1]\n                    distances[1], distances[2] = distances[2], distances[1]\n                end\n\n                for job, member in pairs(M.Party) do\n                    local curMem = TensorCore.mGetEntity(member.id)\n                    if job ~= \"MT\" and job ~= \"ST\" then\n                        local dist = TensorCore.getDistance2d(wind.pos, curMem.pos)\n                        if dist < distances[1] then\n                            -- 比最近的还近，更新最近，原最近变成第二近\n                            nearest[2] = nearest[1]\n                            distances[2] = distances[1]\n                            nearest[1] = curMem\n                            distances[1] = dist\n                        elseif dist < distances[2] then\n                            -- 只比第二近的近，更新第二近\n                            nearest[2] = curMem\n                            distances[2] = dist\n                        end\n                    end\n                end\n                for _, member in pairs(nearest) do\n                    local heading = TensorCore.getHeadingToTarget(wind.pos, member.pos)\n                    local litBlueDraw = Argus2.ShapeDrawer:new(\n                            (GUI:ColorConvertFloat4ToU32(0, 0.5, 1, 0.3)),\n                            (GUI:ColorConvertFloat4ToU32(0, 0.5, 1, 0.3)),\n                            (GUI:ColorConvertFloat4ToU32(0, 0.5, 1, 0.3)),\n                            (GUI:ColorConvertFloat4ToU32(1, 1, 1, 1)),\n                            0.5\n                    )\n                    litBlueDraw:addCone(wind.pos.x, 0, wind.pos.z, 40, math.pi / 2, heading)\n                end\n            end\n        end\n        local pos = M.M11S.WeaponInfo.GuidePos\n        M.FrameDirect(pos.x, pos.z)\n    end\nend\nself.used = true",
						conditions = 
						{
						...
						gVar = "ACR_TensorWeeb3_CD",
						name = "主循环-兵器",
						uuid = "f2e2043a-9cb9-a5b4-89d1-89c40054c2ae",
						version = 2.1,
					},
					inheritedIndex = 1,
				},
				...
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nif M.M11S.CurrentState == M.M11S.State.Meteor2_Start then\n    local cnt = 0\n    for _, player in pairs(M.Party) do\n        local tethers = Argus.getTethersOnEnt(player.id)\n        for _, tether in pairs(tethers) do\n            if tether.type == 57 or tether.type == 249 then\n                cnt = cnt + 1\n                break\n            end\n        end\n    end\n    if cnt >= 4 then\n        M.M11S.CurrentState = M.M11S.State.Meteor2_Link1\n    end\nend\n\nif M.M11S.CurrentState == M.M11S.State.Meteor2_Link1\n        or M.M11S.CurrentState == M.M11S.State.Meteor2_Link2\nthen\n    if M.M11S.TowerPos == nil then\n        local type\n        if M.M11S.CurrentState == M.M11S.State.Meteor2_Link1 then\n            type = 1\n        else\n            type = 2\n        end\n        M.M11S.GetTakeTowerPos(type)\n    else\n        local player = M.GetPlayer()\n        if player.pos.y > 0.5 then\n            if M.M11S.CurrentState == M.M11S.State.Meteor2_Link1 then\n                M.M11S.CurrentState = M.M11S.State.Meteor2_Tower1\n            else\n                M.M11S.CurrentState = M.M11S.State.Meteor2_Tower2\n            end\n            M.M11S.JumpTime = Now()\n        else\n            M.FrameDirect(M.M11S.TowerPos.x, M.M11S.TowerPos.z, 0.3)\n        end\n    end\nend\n\nif M.M11S.CurrentState == M.M11S.State.Meteor2_Tower1\n        or M.M11S.CurrentState == M.M11S.State.Meteor2_Tower2\nthen\n    local player = M.GetPlayer()\n    --落地\n    if player.pos.y < 0.1 and TimeSince(M.M11S.JumpTime) > 1000 then\n        if M.M11S.Meteor2Link.Has then\n            if player.pos.x > 100 then\n                M.FrameDirect(113, 100)\n            else\n                M.FrameDirect(87, 100)\n            end\n        else\n            if player.pos.x > 100 then\n                M.FrameDirect(106.5, 100)\n            else\n                M.FrameDirect(93.5, 100)\n            end\n        end\n    end\nend\n\nif (M.M11S.CurrentState == M.M11S.State.Meteor2_GetMark1\n        or M.M11S.CurrentState == M.M11S.State.Meteor2_GetMark2)\n        and M.M11S.GetMarkTime ~= nil\nthen\n    local changeState\n    for _, player in pairs(M.Party) do\n        local debuff = TensorCore.getBuff(player.id, 2941)\n        if debuff ~= nil then\n            changeState = true\n            break\n        end\n    end\n    if changeState then\n        if M.M11S.CurrentState == M.M11S.State.Meteor2_GetMark1 then\n            M.M11S.CurrentState = M.M11S.State.Meteor2_Debuff1\n            M.M11S.Meteor2Page1To2()\n        else\n            M.M11S.CurrentState = M.M11S.State.Meteor2_Debuff2\n        end\n    else\n        if TimeSince(M.M11S.GetMarkTime) < 2000 then\n            local player = M.GetPlayer()\n            if player.pos.x > 100 then\n                M.FrameDirect(106.5, 100)\n            else\n                M.FrameDirect(93.5, 100)\n            end\n        else\n            local targetPos\n            if M.M11S.Meteor2Link.Has then\n                if M.M11S.Meteor2Link.guidePos == nil then\n                    local linkFrom = M.M11S.Meteor2Link.from\n                    if linkFrom.pos.x < 100 then\n                        if linkFrom.pos.z < 100 then\n                            targetPos = { x = 116, z = 120 }\n                        else\n                            targetPos = { x = 116, z = 80 }\n                        end\n                    else\n                        if linkFrom.pos.z < 100 then\n                            targetPos = { x = 84, z = 120 }\n                        else\n                            targetPos = { x = 84, z = 80 }\n                        end\n                    end\n                    if M.M11S.Meteor2MapEffect ~= nil then\n                        local guidePosX, guidePosZ\n                        if table.contains(M.M11S.Meteor2MapEffect, 22) or table.contains(M.M11S.Meteor2MapEffect, 24) then\n                            guidePosX = targetPos.x + 0.5\n                        elseif table.contains(M.M11S.Meteor2MapEffect, 23) or table.contains(M.M11S.Meteor2MapEffect, 25) then\n                            guidePosX = targetPos.x - 0.5\n                        end\n                        if targetPos.z > 100 then\n                            guidePosZ = targetPos.z - 0.5\n                        else\n                            guidePosZ = targetPos.z + 0.5\n                        end\n                        if guidePosZ < 100 then\n                            M.M11S.Tower2Type = \"Up\"\n                        else\n                            M.M11S.Tower2Type = \"Down\"\n                        end\n                        M.M11S.Meteor2Link.guidePos = { x = guidePosX, z = guidePosZ }\n                    end\n                else\n                    local pos = M.M11S.Meteor2Link.guidePos\n                    M.FrameDirect(pos.x, pos.z)\n                end\n            else\n                local selfPlayer = M.GetPlayer()\n                local partner\n                --找到同组\n                for _, playerId in pairs(M.M11S.Meteor2Marks) do\n                    if playerId ~= selfPlayer.id then\n                        local curPlayer = TensorCore.mGetEntity(playerId)\n                        if curPlayer.pos.x > 100 and selfPlayer.pos.x > 100\n                                or curPlayer.pos.x < 100 and selfPlayer.pos.x < 100\n                        then\n                            partner = curPlayer\n                            break\n                        end\n                    end\n                end\n                if partner ~= nil and partner.pos.z > selfPlayer.pos.z then\n                    M.M11S.Tower2Type = \"Up\"\n                else\n                    M.M11S.Tower2Type = \"Down\"\n                end\n                if selfPlayer.pos.x < 100 then\n                    if M.M11S.Tower2Type == \"Up\" then\n                        targetPos = { x = 84, z = 88.5 }\n                    else\n                        targetPos = { x = 84, z = 111.5 }\n                    end\n                else\n                    if M.M11S.Tower2Type == \"Up\" then\n                        targetPos = { x = 116, z = 88.5 }\n                    else\n                        targetPos = { x = 116, z = 111.5 }\n                    end\n                end\n                local guidePosX\n                if table.contains(M.M11S.Meteor2MapEffect, 22) or table.contains(M.M11S.Meteor2MapEffect, 24) then\n                    guidePosX = targetPos.x + 0.5\n                elseif table.contains(M.M11S.Meteor2MapEffect, 23) or table.contains(M.M11S.Meteor2MapEffect, 25) then\n                    guidePosX = targetPos.x - 0.5\n                end\n                M.FrameDirect(guidePosX, targetPos.z)\n            end\n            if M.Config.Main.M11SExDraw and TimeSince(M.M11S.GetMarkTime) > 3500 then\n                for _, member in pairs(M.Party) do\n                    if TensorCore.hasBuff(member.id, 2941) then\n                        break\n                    end\n                    local curPlayer = TensorCore.mGetEntity(member.id)\n                    local tethers = Argus.getTethersOnEnt(curPlayer.id)\n                    local hasLink = false\n                    if tethers ~= nil and table.size(tethers) > 0 then\n                        for _, tether in pairs(tethers) do\n                            if tether.type == 57 or tether.type == 249 then\n                                hasLink = true\n                                local linkFrom = TensorCore.mGetEntity(tether.partnerid)\n                                local heading = TensorCore.getHeadingToTarget(linkFrom.pos, curPlayer.pos)\n                                local redDraw = Argus2.ShapeDrawer:new(\n                                        (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                                        (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                                        (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                                        (GUI:ColorConvertFloat4ToU32(1, 1, 1, 1)),\n                                        1\n                                )\n                                redDraw:addRect(linkFrom.pos.x, linkFrom.pos.y, linkFrom.pos.z, 80, 10, heading)\n                            end\n                        end\n                    end\n                    local player = M.GetPlayer()\n                    if not hasLink and table.contains(M.M11S.Meteor2Marks, player.id) then\n                        local curBoss = TensorCore.mGetEntity(M.M11S.CurrentBoss.id)\n                        local heading = TensorCore.getHeadingToTarget(curBoss.pos, curPlayer.pos)\n                        local yellowDraw = Argus2.ShapeDrawer:new(\n                                (GUI:ColorConvertFloat4ToU32(1, 1, 0, 0.2)),\n                                (GUI:ColorConvertFloat4ToU32(1, 1, 0, 0.2)),\n                                (GUI:ColorConvertFloat4ToU32(1, 1, 0, 0.2)),\n                                (GUI:ColorConvertFloat4ToU32(1, 1, 1, 1)),\n                                1\n                        )\n                        yellowDraw:addRect(curBoss.pos.x, curBoss.pos.y, curBoss.pos.z, 80, 6, heading)\n                    end\n                end\n            end\n        end\n    end\nend\n\nif M.Config.Main.M11SExDraw and M.M11S.Meteor2MapEffect ~= nil then\n    for _, effectId in pairs(M.M11S.Meteor2MapEffect) do\n        local posX\n        if effectId == 22 then\n            posX = 79\n        elseif effectId == 23 then\n            posX = 89\n        elseif effectId == 24 then\n            posX = 111\n        elseif effectId == 25 then\n            posX = 121\n        end\n        local drawer = Argus2.ShapeDrawer:new(\n                (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                (GUI:ColorConvertFloat4ToU32(1, 1, 1, 1)),\n                1\n        )\n        drawer:addRect(posX, 0, 80, 40, 10, 0)\n    end\nend\n\nif M.M11S.CurrentState == M.M11S.State.Meteor2_GatherMark then\n    local curHealer = TensorCore.mGetEntity(M.M11S.Meteor2GatherPartnerId)\n    local guidePos\n    local player = M.GetPlayer()\n    if M.M11S.Meteor2GatherPartnerId == player.id then\n        local midPos\n        if player.pos.x > 100 then\n            midPos = { x = 106.5, z = 100 }\n        else\n            midPos = { x = 93.5, z = 100 }\n        end\n        if M.M11S.Tower2Type == \"Up\" then\n            guidePos = { x = midPos.x, z = midPos - 2 }\n        else\n            guidePos = { x = midPos.x, z = midPos + 2 }\n        end\n    else\n        if M.M11S.Tower2Type == \"Up\" then\n            guidePos = { x = curHealer.pos.x, z = curHealer.pos.z - 3 }\n        else\n            guidePos = { x = curHealer.pos.x, z = curHealer.pos.z + 3 }\n        end\n    end\n    if M.Config.Main.M11SExDraw then\n        local distances = TensorCore.getHeadingToTarget(curHealer.pos, player.pos)\n        local drawer\n        if distances >= 5 then\n            drawer = Argus2.ShapeDrawer:new(\n                    (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0)),\n                    (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0)),\n                    (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0)),\n                    (GUI:ColorConvertFloat4ToU32(1, 0, 0, 1)),\n                    5\n            )\n        else\n            drawer = Argus2.ShapeDrawer:new(\n                    (GUI:ColorConvertFloat4ToU32(0, 1, 0, 0)),\n                    (GUI:ColorConvertFloat4ToU32(0, 1, 0, 0)),\n                    (GUI:ColorConvertFloat4ToU32(0, 1, 0, 0)),\n                    (GUI:ColorConvertFloat4ToU32(0, 1, 0, 1)),\n                    5\n            )\n        end\n        drawer:addCircle(curHealer.pos.x, 0, curHealer.pos.z, 5)\n    end\n    M.FrameDirect(guidePos.x, guidePos.z)\nend\n\nif M.M11S.CurrentState == M.M11S.State.Meteor2_GatherEnd then\n    -- 动态计算位置\n    local player = M.GetPlayer()\n    if player.pos.y > 0.5 then\n        M.M11S.CurrentState = M.M11S.State.Meteor2_Tower3\n        M.M11S.JumpTime = Now()\n    else\n        local upMe = 0\n        local selfSideCnt = 0\n        for _, member in pairs(M.Party) do\n            local curPlayer = TensorCore.mGetEntity(member.id)\n\n            if (player.pos.x > 100 and curPlayer.pos.x > 100) or (player.pos.x < 100 and curPlayer.pos.x < 100) then\n                selfSideCnt = selfSideCnt + 1\n            end\n            if player.id ~= member.id\n                    and ((player.pos.x > 100 and curPlayer.pos.x > 100) or (player.pos.x < 100 and curPlayer.pos.x < 100))\n            then\n                if curPlayer.pos.z < player.pos.z then\n                    upMe = upMe + 1\n                end\n            end\n        end\n        local myTower\n        if selfSideCnt == 4 then\n            if upMe < 2 then\n                if player.pos.x > 100 then\n                    myTower = M.M11S.TowerData.rightUp\n                else\n                    myTower = M.M11S.TowerData.leftUp\n                end\n            else\n                if player.pos.x > 100 then\n                    myTower = M.M11S.TowerData.rightDown\n                else\n                    myTower = M.M11S.TowerData.leftDown\n                end\n            end\n        else\n            if M.M11S.Tower2Type == \"Up\" then\n                if player.pos.x > 100 then\n                    myTower = M.M11S.TowerData.rightUp\n                else\n                    myTower = M.M11S.TowerData.leftUp\n                end\n            else\n                if player.pos.x > 100 then\n                    myTower = M.M11S.TowerData.rightDown\n                else\n                    myTower = M.M11S.TowerData.leftDown\n                end\n            end\n        end\n        local guidePos\n        if M.M11S.Meteor2HitType == nil then\n            local curBoss = TensorCore.mGetEntity(MuAiGuide.M11S.CurrentBoss.id)\n            if M.IsSameDirection(curBoss.pos.h, math.pi / 2) then\n                M.M11S.Meteor2HitType = \"Right\" --搬走了右边\n                if player.pos.x > 100 then\n                    guidePos = myTower.leapPos\n                else\n                    guidePos = myTower.localPos\n                end\n            elseif M.IsSameDirection(curBoss.pos.h, math.pi * 3 / 2) then\n                M.M11S.Meteor2HitType = \"Left\" --搬走了左边\n                if player.pos.x > 100 then\n                    guidePos = myTower.localPos\n                else\n                    guidePos = myTower.leapPos\n                end\n            end\n        else\n            if player.pos.x > 100 then\n                if M.M11S.Meteor2HitType == \"Right\" then\n                    guidePos = myTower.leapPos\n                else\n                    guidePos = myTower.localPos\n                end\n            else\n                if M.M11S.Meteor2HitType == \"Left\" then\n                    guidePos = myTower.leapPos\n                else\n                    guidePos = myTower.localPos\n                end\n            end\n        end\n        if guidePos ~= nil then\n            M.FrameDirect(guidePos.x, guidePos.z, 0.3)\n        end\n    end\nend\n\nif M.M11S.CurrentState == M.M11S.State.Meteor2_Tower3 then\n    if TimeSince(M.M11S.BreakTime) < 15000 then\n        local curBoss = TensorCore.mGetEntity(MuAiGuide.M11S.CurrentBoss.id)\n        local curHeading = M.SetHeading2Pi(curBoss.pos.h)\n        local dir, guidePos\n        local player = M.GetPlayer()\n        if player.pos.y < 0.1 and TimeSince(M.M11S.JumpTime) > 1000 then\n            if M.M11S.Meteor2SafeGroudPos == nil then\n                if M.M11S.Meteor2HitType == \"Right\" then\n                    if math.pi < curHeading and curHeading < math.pi * 3 / 2 then\n                        guidePos = { x = 84, z = 115 }\n                        dir = math.pi * 4 / 3\n                    elseif math.pi * 3 / 2 < curHeading and curHeading < 2 * math.pi then\n                        guidePos = { x = 84, z = 85 }\n                        dir = math.pi * 5 / 3\n                    end\n                elseif M.M11S.Meteor2HitType == \"Left\" then\n                    if 0 < curHeading and curHeading < math.pi / 2 then\n                        guidePos = { x = 116, z = 85 }\n                        dir = math.pi / 3\n                    elseif math.pi / 2 < curHeading and curHeading < math.pi then\n                        guidePos = { x = 116, z = 115 }\n                        dir = math.pi * 2 / 3\n                    end\n                end\n            else\n                guidePos = M.M11S.Meteor2SafeGroudPos\n                dir = M.M11S.Meteor2DangerDir\n            end\n            if M.Config.Main.M11SExDraw and dir ~= nil then\n                local drawer = Argus2.ShapeDrawer:new(\n                        (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                        (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                        (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                        (GUI:ColorConvertFloat4ToU32(1, 1, 1, 1)),\n                        1\n                )\n                local startPos = TensorCore.getPosInDirection(curBoss.pos, dir + math.pi, 5)\n                drawer:addRect(startPos.x, 0, startPos.z, 38, 40, dir)\n            end\n            if guidePos ~= nil then\n                M.FrameDirect(guidePos.x, guidePos.z)\n            end\n        end\n    else\n        M.M11S.CurrentState = M.M11S.State.Meteor2_Hit\n    end\nend\n\nself.used = true",
						conditions = 
						{
							...
							{
								"6057d08b-fae1-2c5f-9386-36b74f082f65",
								true,
							},
						},
						gVar = "ACR_TensorWeeb3_CD",
						name = "主循环-王者陨石",
						uuid = "c46504d3-2486-2775-a866-cdfd108680c0",
						version = 2.1,
					},
					inheritedIndex = 2,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nif M.M11S.CurrentState == M.M11S.State.Meteor3_Start then\n    if table.contains({ \"MT\", \"ST\", \"D1\", \"D2\" }, M.SelfPos) then\n        M.FrameDirect(100, 100)\n    else\n        -- 动态计算站哪\n        local player = M.GetPlayer()\n        -- local selfOrder = M.IndexOf({ \"H1\", \"H2\", \"D3\", \"D4\" }, M.SelfPos)\n        local curRanges = {}\n        local value = 0\n        for job, ent in pairs(M.Party) do\n            if player.id ~= ent.id and table.contains({ \"H1\", \"H2\", \"D3\", \"D4\" }, job) then\n                local curPlayer = TensorCore.mGetEntity(ent.id)\n                table.insert(curRanges, curPlayer)\n                value = value + curPlayer.pos.x\n            end\n        end\n        table.sort(curRanges, function(a, b)\n            return a.pos.z < b.pos.z\n        end)\n        local posX = value / 3\n        if posX > 93 then\n            posX = 93\n        end\n        if M.SelfPos == \"H1\" then\n            M.FrameDirect(posX, curRanges[1].pos.z - 2)\n        elseif M.SelfPos == \"H1\" then\n            M.FrameDirect(posX, curRanges[1].pos.z + 2)\n        elseif M.SelfPos == \"D3\" then\n            local posZ = (curRanges[1].pos.z + curRanges[2].pos.z) / 2\n            M.FrameDirect(posX, posZ)\n        elseif M.SelfPos == \"D4\" then\n            local posZ = (curRanges[2].pos.z + curRanges[3].pos.z) / 2\n            M.FrameDirect(posX, posZ)\n        end\n    end\nend\n\nif M.M11S.CurrentState == M.M11S.State.Meteor3_Guide1 then\n    if TimeSince(M.M11S.Meteor3Info.BoomTime) < 5000 then\n        if table.contains({ \"MT\", \"ST\", \"D1\", \"D2\" }, M.SelfPos) then\n            M.FrameDirect(100, 100)\n        else\n            local curPlayer = M.GetPlayer()\n            if table.contains(M.M11S.Meteor3Info.Marked, curPlayer.id) then\n                local otherJob\n                for job, ent in pairs(M.Party) do\n                    if ent.id ~= curPlayer.id and table.contains(M.M11S.Meteor3Info.Marked, ent.id) then\n                        otherJob = job\n                        break\n                    end\n                    if otherJob ~= nil then\n                        break\n                    end\n                end\n                local selfIdx = M.IndexOf(M.M11S.Meteor3Info.JobOrder, M.SelfPos)\n                local otherIdx = M.IndexOf(M.M11S.Meteor3Info.JobOrder, otherJob)\n                local upBoom, bottomBoom\n                for _, curBoom in pairs(M.M11S.Meteor3Info.boom) do\n                    if upBoom == nil then\n                        upBoom = curBoom\n                    else\n                        if upBoom.pos.z > curBoom.pos.z then\n                            bottomBoom = upBoom\n                            upBoom = curBoom\n                        else\n                            bottomBoom = curBoom\n                        end\n                    end\n                end\n                local selfBoom, guidePosX, guidePosZ\n                if selfIdx < otherIdx then\n                    selfBoom = upBoom\n                    guidePosZ = 81\n                else\n                    selfBoom = bottomBoom\n                    guidePosZ = 119\n                end\n                if selfBoom.pos.x > 100 then\n                    guidePosX = 89\n                else\n                    guidePosX = 111\n                end\n                M.FrameDirect(guidePosX, guidePosZ)\n            else\n                M.FrameDirect(100, 100)\n            end\n        end\n    else\n        M.M11S.CurrentState = M.M11S.State.Meteor3_CatchBoom\n    end\nend\n\nif M.M11S.CurrentState == M.M11S.State.Meteor3_CatchBoom\n        and TimeSince(M.M11S.Meteor3Info.BoomTime) > 25000 then\n    local changeState\n    for _, player in pairs(M.Party) do\n        local debuff = TensorCore.getBuff(player.id, 2937)\n        if debuff ~= nil then\n            changeState = true\n            break\n        end\n    end\n    if changeState then\n        M.M11S.CurrentState = M.M11S.State.Meteor3_Link\n    else\n        local player = M.GetPlayer()\n        local selfLink = nil\n        local cnt = 0\n        for _, member in pairs(M.Party) do\n            local tethers = Argus.getTethersOnEnt(member.id)\n            for _, tether in pairs(tethers) do\n                if tether.type == 57 or tether.type == 249 then\n                    local linkFrom = TensorCore.mGetEntity(tether.partnerid)\n                    if M.Config.Main.M11SExDraw then\n                        local redDraw = Argus2.ShapeDrawer:new(\n                                (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                                (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                                (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n                                (GUI:ColorConvertFloat4ToU32(1, 1, 1, 1)),\n                                1\n                        )\n                        local curPlayer = TensorCore.mGetEntity(member.id)\n                        local heading = TensorCore.getHeadingToTarget(linkFrom.pos, curPlayer.pos)\n                        redDraw:addRect(linkFrom.pos.x, linkFrom.pos.y, linkFrom.pos.z, 80, 10, heading)\n                    end\n                    cnt = cnt + 1\n                    if member.id == player.id then\n                        selfLink = linkFrom\n                    end\n                end\n            end\n        end\n        if cnt >= 4 then\n            if selfLink ~= nil then\n                if selfLink.pos.z < 90 then\n                    --上\n                    targetPos = { x = 119.5, z = 119.5 }\n                elseif selfLink.pos.x < 90 then\n                    --左\n                    targetPos = { x = 119.5, z = 81.5 }\n                elseif selfLink.pos.z > 110 then\n                    -- 下\n                    targetPos = { x = 81.5, z = 81.5 }\n                else\n                    -- 右边\n                    targetPos = { x = 81.5, z = 119.5 }\n                end\n                M.FrameDirect(targetPos.x, targetPos.z)\n            else\n                M.FrameDirect(100, 100)\n            end\n        end\n    end\nend\n\n-- 双向，四项火\nif M.M11S.CurrentState == M.M11S.State.Meteor3_Link then\n    local changeState\n    for _, player in pairs(M.Party) do\n        local debuff = TensorCore.getBuff(player.id, 2941)\n        if debuff ~= nil then\n            changeState = true\n            break\n        end\n    end\n    if changeState then\n        M.M11S.CurrentState = M.M11S.State.Meteor3_End\n    else\n        if M.Config.Main.M11SExDraw then\n            local curBoss = TensorCore.mGetEntity(M.M11S.CurrentBoss.id)\n            local curFramePlayer = {}\n            for _, member in pairs(M.Party) do\n                table.insert(curFramePlayer, TensorCore.mGetEntity(member.id))\n            end\n            table.sort(curFramePlayer, function(a, b)\n                if a.alive and not b.alive then\n                    return true\n                elseif not a.alive and b.alive then\n                    return false\n                else\n                    return TensorCore.getDistance2d(curBoss.pos, a.pos) < TensorCore.getDistance2d(curBoss.pos, b.pos)\n                end\n            end)\n            local maxIdx\n            if M.M11S.Meteor3Info.LastFrame == 46170 then\n                maxIdx = 4\n            elseif M.M11S.Meteor3Info.LastFrame == 47037 then\n                maxIdx = 2\n            end\n            for i = 1, maxIdx do\n                local yellowDraw = Argus2.ShapeDrawer:new(\n                        (GUI:ColorConvertFloat4ToU32(1, 1, 0, 0.2)),\n                        (GUI:ColorConvertFloat4ToU32(1, 1, 0, 0.2)),\n                        (GUI:ColorConvertFloat4ToU32(1, 1, 0, 0.2)),\n                        (GUI:ColorConvertFloat4ToU32(1, 1, 1, 1)),\n                        1\n                )\n                local heading = TensorCore.getHeadingToTarget(curBoss.pos, curFramePlayer[i].pos)\n                yellowDraw:addRect(curBoss.pos.x, curBoss.pos.y, curBoss.pos.z, 80, 6, heading)\n            end\n        end\n\n        if M.M11S.Meteor3Info.LastFrameEnd == nil or M.M11S.Meteor3Info.LastFrameEnd == false then\n            if M.M11S.Meteor3Info.LastFrameEnd == nil then\n                M.M11S.Meteor3Info.LastFrameEnd = false\n                -- 首先检查点名是否混乱，混乱，放弃指路\n                for job, member in pairs(M.Party) do\n                    if job == \"D1\" or job == \"D2\" or table.contains(M.M11S.Meteor3Info.Marked, M.GetPlayer().id) then\n                        local tethers = Argus.getTethersOnEnt(member.id)\n                        for _, tether in pairs(tethers) do\n                            if tether.type == 57 or tether.type == 249 then\n                                M.M11S.Meteor3Info.LastFrameEnd = true\n                                break\n                            end\n                        end\n                    end\n                    if M.M11S.Meteor3Info.LastFrameEnd then\n                        M.Info(\"点名混乱了，自己看吧!<se.1>\")\n                        break\n                    end\n                end\n            end\n            if (not M.M11S.Meteor3Info.LastFrameEnd) and (M.SelfPos == \"D1\" or M.SelfPos == \"D2\" or table.contains(M.M11S.Meteor3Info.Marked, M.GetPlayer().id)) then\n                if M.M11S.Meteor3Info.LastFramePos == nil then\n                    if M.M11S.Meteor3Info.LastFrame == 46170 then\n                        if M.SelfPos == \"D1\" then\n                            if M.Config.Main.M11SGatherType == 1 then\n                                M.M11S.Meteor3Info.LastFramePos = { x = 97.5, z = 97.5 }\n                            else\n                                M.M11S.Meteor3Info.LastFramePos = { x = 96.3, z = 100 }\n                            end\n                        elseif M.SelfPos == \"D2\" then\n                            if M.Config.Main.M11SGatherType == 1 then\n                                M.M11S.Meteor3Info.LastFramePos = { x = 102.5, z = 102.5 }\n                            else\n                                M.M11S.Meteor3Info.LastFramePos = { x = 103.7, z = 100 }\n                            end\n                        else\n                            for job, ent in pairs(M.Party) do\n                                if ent.id ~= M.GetPlayer().id and table.contains(M.M11S.Meteor3Info.Marked, ent.id) then\n                                    otherJob = job\n                                    break\n                                end\n                            end\n                            local selfIdx = M.IndexOf(M.M11S.Meteor3Info.JobOrder, M.SelfPos)\n                            local otherIndex = M.IndexOf(M.M11S.Meteor3Info.JobOrder, otherJob)\n                            if selfIdx > otherIndex then\n                                if M.Config.Main.M11SGatherType == 1 then\n                                    M.M11S.Meteor3Info.LastFramePos = { x = 97.5, z = 102.5 }\n                                else\n                                    M.M11S.Meteor3Info.LastFramePos = { x = 100, z = 103.7 }\n                                end\n                            else\n                                if M.Config.Main.M11SGatherType == 1 then\n                                    M.M11S.Meteor3Info.LastFramePos = { x = 102.5, z = 97.5 }\n                                else\n                                    M.M11S.Meteor3Info.LastFramePos = { x = 100, z = 96.3 }\n                                end\n                            end\n                        end\n                    elseif M.M11S.Meteor3Info.LastFrame == 47037 then\n                        if M.SelfPos == \"D1\" then\n                            M.M11S.Meteor3Info.LastFramePos = { x = 100, z = 94 }\n                        elseif M.SelfPos == \"D2\" then\n                            M.M11S.Meteor3Info.LastFramePos = { x = 100, z = 106 }\n                        else\n                            for job, ent in pairs(M.Party) do\n                                if ent.id ~= M.GetPlayer().id and table.contains(M.M11S.Meteor3Info.Marked, ent.id) then\n                                    otherJob = job\n                                    break\n                                end\n                            end\n                            local selfIdx = M.IndexOf(M.M11S.Meteor3Info.JobOrder, M.SelfPos)\n                            local otherIndex = M.IndexOf(M.M11S.Meteor3Info.JobOrder, otherJob)\n                            if selfIdx > otherIndex then\n                                M.M11S.Meteor3Info.LastFramePos = { x = 100, z = 103 }\n                            else\n                                M.M11S.Meteor3Info.LastFramePos = { x = 100, z = 97 }\n                            end\n                        end\n                    end\n                else\n                    local pos = M.M11S.Meteor3Info.LastFramePos\n                    M.FrameDirect(pos.x, pos.z)\n                end\n            end\n        end\n    end\nend\n\nself.used = true",
						conditions = 
						{
						...
						gVar = "ACR_RikuMNK3_CD",
						name = "主循环-陨石狂奔",
						uuid = "3fb2226d-4edc-8a40-b9b9-e100dcc579f7",
						version = 2.1,
					},
					inheritedIndex = 3,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local redDraw2 = Argus2.ShapeDrawer:new(\n        (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n        (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n        (GUI:ColorConvertFloat4ToU32(1, 0, 0, 0.2)),\n        (GUI:ColorConvertFloat4ToU32(1, 0, 0, 1)),\n        3\n)\nfor _, wind in pairs(TensorCore.entityList(\"contentid=14307\")) do\n    if Argus.isEntityVisible(wind) then\n        redDraw2:addCircle(wind.pos.x, wind.pos.y, wind.pos.z, 4.3, true)\n    end\nend\nself.used = true",
						conditions = 
						{
						...
						gVar = "ACR_TensorWeeb3_CD",
						name = "6连兵器-大漩涡绘图",
						uuid = "670b1434-3b50-7b8d-9fd0-7da085f076c1",
						version = 2.1,
					},
				},
			},
			conditions = 
			{
				...
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return MuAiGuide.Config.Main.M11SExDraw",
						name = "画图设置",
						uuid = "73f59343-3c8e-4978-9544-35ffa6d1bc03",
						version = 3,
					},
					inheritedIndex = 2,
				},
				...
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return data ~= nil and data.MuAiM11SDrawDeathCastId ~= nil",
						name = "当前处于显示死刑中",
						uuid = "f61323c3-aa84-edaf-b26f-e9dc55863f5f",
						version = 3,
					},
				},
				
				{
					...
					{
						category = "Lua",
						conditionLua = " return MuAiGuide.M11S.CurrentState >= MuAiGuide.M11S.State.Weapon3_Start \n\tand MuAiGuide.M11S.CurrentState < MuAiGuide.M11S.State.Weapon3_End ",
						name = "6连兵器中",
						uuid = "cd5179b0-09eb-76c0-9dbc-e203655b67fd",
						version = 3,
					},
				},
				
				{
					...
					{
						category = "Lua",
						conditionLua = " return MuAiGuide.M11S.CurrentState >= MuAiGuide.M11S.State.Weapon1_Start \n\tand MuAiGuide.M11S.CurrentState <= MuAiGuide.M11S.State.Weapon3_End ",
						name = "3连兵器到6连兵器结束",
						uuid = "d47bff10-5a20-28a6-a170-7e8497075651",
						version = 3,
					},
				},
				
				{
					data = 
					{
						...
						conditionLua = " return MuAiGuide.M11S.CurrentState >= MuAiGuide.M11S.State.Meteor2_Start \n\tand MuAiGuide.M11S.CurrentState <= MuAiGuide.M11S.State.Meteor2_end ",
						name = "王者陨石阶段",
						uuid = "6057d08b-fae1-2c5f-9386-36b74f082f65",
						version = 3,
					},
					inheritedIndex = 8,
				},
				
				{
					...
					{
						category = "Lua",
						conditionLua = " return MuAiGuide.M11S.CurrentState >= MuAiGuide.M11S.State.Meteor3_Start \n\tand MuAiGuide.M11S.CurrentState < MuAiGuide.M11S.State.Meteor3_End ",
						name = "陨石狂奔阶段",
						uuid = "e7db56cc-52d2-5ffd-ab7b-95f8c22002db",
						version = 3,
					},
					inheritedIndex = 9,
				},
		...
		data = 
		{
			actions = 
			{
				
				{
					...
					{
						aType = "Lua",
						actionLua = "data.MuAiM11SDrawDeathCastTime = Now()\ndata.MuAiM11SDrawDeathCastId = eventArgs.spellID\nself.used = true",
						conditions = 
						{
							...
							{
								"599e9feb-a4c2-9634-9533-e469c9016c28",
								true,
							},
						},
						gVar = "ACR_TensorWeeb3_CD",
						name = "死刑数据采集",
						uuid = "1043ba46-3471-a0b0-9503-82d61e57a8a5",
						version = 2.1,
					},
					inheritedIndex = 1,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nlocal curEnt = TensorCore.mGetEntity(eventArgs.entityID)\nlocal time = eventArgs.channelTimeMax * 1000\nif M.Config.Main.M11SExDraw then\n    local redDraw = Argus2.ShapeDrawer:new(\n            (GUI:ColorConvertFloat4ToU32(0.4, 0, 0, 0.2)),\n            (GUI:ColorConvertFloat4ToU32(0.4, 0, 0, 0.2)),\n            (GUI:ColorConvertFloat4ToU32(0.4, 0, 0, 0.2)),\n            (GUI:ColorConvertFloat4ToU32(1, 1, 1, 1)),\n            1\n    )\n    redDraw:addTimedCenteredRect(time, curEnt.pos.x, 0, curEnt.pos.z, 10, 60, curEnt.pos.h + math.pi / 2)\nend\nif M.M11S.Blade == nil then\n    M.M11S.Blade = {}\n    M.M11S.BladeIds = {}\nend\nif table.size(M.M11S.BladeIds) < 6 then\n    table.insert(M.M11S.BladeIds, eventArgs.entityID)\n    table.insert(M.M11S.Blade, curEnt)\n    local outBoom = {}\n    if table.size(M.M11S.BladeIds) == 6 then\n        for i, ent in pairs(M.M11S.Blade) do\n            local dis = TensorCore.getDistance2d(ent.pos, { x = 100, y = 0, z = 100 })\n            if dis > 3 then\n                table.insert(outBoom, ent)\n            end\n        end\n        local noBoomIdx\n        for i = 0, 3 do\n            local hasBoom = false\n            for _, ent in pairs(outBoom) do\n                local curHeading = math.pi / 2 * i\n                local entHeading = TensorCore.getHeadingToTarget({ x = 100, y = 0, z = 100 }, ent.pos)\n                if M.IsSameDirection(curHeading, entHeading, 0.1) then\n                    hasBoom = true\n                end\n            end\n            if not hasBoom then\n                noBoomIdx = i\n                break\n            end\n        end\n        local guidePos\n        -- 缺口在哪？\n        if noBoomIdx == 0 then\n            if M.SelfPos == \"MT\" or M.SelfPos == \"D1\" then\n                guidePos = { x = 92, z = 100 }\n            elseif M.SelfPos == \"ST\" or M.SelfPos == \"D2\" then\n                guidePos = { x = 108, z = 100 }\n            elseif M.SelfPos == \"H1\" or M.SelfPos == \"D3\" then\n                guidePos = { x = 93.7, z = 115 }\n            elseif M.SelfPos == \"H2\" or M.SelfPos == \"D4\" then\n                guidePos = { x = 106.3, z = 115 }\n            end\n        elseif noBoomIdx == 1 then\n            if M.SelfPos == \"MT\" or M.SelfPos == \"D1\" then\n                guidePos = { x = 100, z = 92 }\n            elseif M.SelfPos == \"ST\" or M.SelfPos == \"D2\" then\n                guidePos = { x = 100, z = 108 }\n            elseif M.SelfPos == \"H1\" or M.SelfPos == \"D3\" then\n                guidePos = { x = 115, z = 106.3 }\n            elseif M.SelfPos == \"H2\" or M.SelfPos == \"D4\" then\n                guidePos = { x = 115, z = 93.7 }\n            end\n        elseif noBoomIdx == 2 then\n            if M.SelfPos == \"MT\" or M.SelfPos == \"D1\" then\n                guidePos = { x = 92, z = 100 }\n            elseif M.SelfPos == \"ST\" or M.SelfPos == \"D2\" then\n                guidePos = { x = 108, z = 100 }\n            elseif M.SelfPos == \"H1\" or M.SelfPos == \"D3\" then\n                guidePos = { x = 106.3, z = 85 }\n            elseif M.SelfPos == \"H2\" or M.SelfPos == \"D4\" then\n                guidePos = { x = 93.7, z = 85 }\n            end\n        elseif noBoomIdx == 3 then\n            if M.SelfPos == \"MT\" or M.SelfPos == \"D1\" then\n                guidePos = { x = 100, z = 92 }\n            elseif M.SelfPos == \"ST\" or M.SelfPos == \"D2\" then\n                guidePos = { x = 100, z = 108 }\n            elseif M.SelfPos == \"H1\" or M.SelfPos == \"D3\" then\n                guidePos = { x = 85, z = 93.7 }\n            elseif M.SelfPos == \"H2\" or M.SelfPos == \"D4\" then\n                guidePos = { x = 85, z = 106.3 }\n            end\n        end\n        M.DirectTo(guidePos.x, guidePos.z, time)\n    end\nend\n\nself.used = true",
						conditions = 
						{
							...
							{
								"16bb9852-efcf-a977-ac2c-ffde0662d2da",
								true,
							},
						},
						gVar = "ACR_RikuMNK3_CD",
						name = "米字型劈刀",
						uuid = "bef2d249-bf0a-dd0e-ab1c-0c0b728ec8f4",
						version = 2.1,
					},
					inheritedIndex = 2,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "MuAiGuide.M11S.CurrentState = MuAiGuide.M11S.State.Weapon1_Start\nself.used = true",
						conditions = 
						{
							...
							{
								"a3b7139c-b3a9-3e6b-8175-830f52c3a921",
								true,
							},
							
							{
								"1e73bf37-8a27-da19-b9a3-7783f9117aa6",
								true,
							},
						},
						gVar = "ACR_TensorWeeb3_CD",
						name = "进入3连兵器1",
						uuid = "ab524b3a-0f4e-236f-a9ba-6c280b28bf93",
						version = 2.1,
					},
					inheritedIndex = 1,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "MuAiGuide.M11S.CurrentState = MuAiGuide.M11S.State.Weapon2_Start\nself.used = true",
						conditions = 
						{
							...
							{
								"dd416fb1-1595-99e6-ba90-08b042b7231a",
								true,
							},
							
							{
								"0db5b078-547f-e6c2-a183-5441c51345a0",
								true,
							},
						},
						gVar = "ACR_TensorWeeb3_CD",
						name = "进入3连兵器2",
						uuid = "23ce0296-a170-628c-9735-85949f0a044e",
						version = 2.1,
					},
					inheritedIndex = 2,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "MuAiGuide.M11S.CurrentState = MuAiGuide.M11S.State.Weapon3_Start\nself.used = true",
						conditions = 
						{
							...
							{
								"9881615b-f494-85ff-98ba-4f68742f42c7",
								true,
							},
						},
						gVar = "ACR_TensorWeeb3_CD",
						name = "进入6连兵器",
						uuid = "b7e56c2e-366c-4a48-a5e2-e36cacf90ee5",
						version = 2.1,
					},
					inheritedIndex = 3,
				},
				...
				
				{
					...
					{
						aType = "Lua",
						actionLua = "MuAiGuide.M11S.Meteor1.StartCastTimer = Now()\nself.used = true",
						conditions = 
						{
				...
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local time = eventArgs.channelTimeMax * 1000\nif table.contains({ \"MT\", \"H1\", \"D1\", \"D3\" }, MuAiGuide.SelfPos) then\n\tMuAiGuide.DirectTo(99, 100, time)\nelse\n\tMuAiGuide.DirectTo(101, 100, time)\nend\nself.used = true",
						conditions = 
						{
							...
							{
								"cdc353e5-0e50-2da4-b26b-cba68c1fd602",
								true,
							},
						},
						gVar = "ACR_TensorWeeb3_CD",
						name = "开始拆地板",
						uuid = "5ab518b8-2916-ed2e-9c28-f811719b2067",
						version = 2.1,
					},
					inheritedIndex = 6,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "MuAiGuide.M11S.CurrentState = MuAiGuide.M11S.State.Meteor2_Start\nMuAiGuide.M11S.OrbitalOmen = nil\nself.used = true",
						conditions = 
						{
							...
							{
								"fcd424a1-fa9c-b941-b3d4-a177a774c78d",
								true,
							},
						},
						gVar = "ACR_TensorWeeb3_CD",
						name = "进入王者陨石阶段",
						uuid = "f4877b23-8419-87db-a108-613fa0e8354c",
						version = 2.1,
					},
					inheritedIndex = 1,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nM.M11S.CurrentState = M.M11S.State.Meteor2_GatherEnd\nM.M11S.BreakTime = Now()\nif eventArgs.spellID == 46160 then\n    -- 1点安全\n    M.M11S.Meteor2HitType = \"Right\"\n    M.M11S.Meteor2SafeGroudPos = { x = 84, z = 85 }\n    M.M11S.Meteor2DangerDir = math.pi * 5 / 3\nelseif eventArgs.spellID == 46154 then\n    -- 2点安全\n    M.M11S.Meteor2HitType = \"Left\"\n    M.M11S.Meteor2SafeGroudPos = { x = 116, z = 85 }\n    M.M11S.Meteor2DangerDir = math.pi / 3\nelseif eventArgs.spellID == 46156 then\n    -- 3点安全\n    M.M11S.Meteor2HitType = \"Left\"\n    M.M11S.Meteor2SafeGroudPos = { x = 116, z = 115 }\n    M.M11S.Meteor2DangerDir = math.pi * 2 / 3\nelseif eventArgs.spellID == 46158 then\n    -- 4点安全\n    M.M11S.Meteor2HitType = \"Right\"\n    M.M11S.Meteor2SafeGroudPos = { x = 84, z = 115 }\n    M.M11S.Meteor2DangerDir = math.pi * 4 / 3\nend\nself.used = true",
						conditions = 
						{
							...
							{
								"e294ba3c-78ed-ebf7-8e0b-1d5ff7ed4f23",
								true,
							},
						},
						gVar = "ACR_TensorWeeb3_CD",
						name = "登天碎地读条开始",
						uuid = "8a55d519-c566-fb8e-a32b-48e5735eb84f",
						version = 2.1,
					},
					inheritedIndex = 8,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "MuAiGuide.M11S.CurrentState = MuAiGuide.M11S.State.Meteor3_Start\nself.used = true",
						conditions = 
						{
							...
							{
								"1eb74c66-cda9-4f74-9531-d17a7c8c6de6",
								true,
							},
						},
						gVar = "ACR_TensorWeeb3_CD",
						name = "进入陨石狂奔",
						uuid = "43dc02a9-be5f-ce72-924d-198fe07a1269",
						version = 2.1,
					},
					inheritedIndex = 10,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "local M = MuAiGuide\nlocal curEnt = TensorCore.mGetEntity(eventArgs.entityID)\nif eventArgs.spellID == 46166 then\n    table.insert(M.M11S.Meteor3Info.Spell46166, curEnt)\nelseif eventArgs.spellID == 46167 then\n    table.insert(M.M11S.Meteor3Info.Spell46167, curEnt)\nend\n\nlocal guidePos, selfTower\nif M.SelfPos == \"MT\" or M.SelfPos == \"ST\" then\n    if table.size(M.M11S.Meteor3Info.Spell46166) == 2 then\n        local MtTake, StTake = M.M11S.Meteor3Info.FindDir(M.M11S.Meteor3Info.Spell46166[1], M.M11S.Meteor3Info.Spell46166[2])\n        if M.SelfPos == \"MT\" then\n            selfTower = MtTake\n        else\n            selfTower = StTake\n        end\n        local heading = TensorCore.getHeadingToTarget({ x = 100, y = 0, z = 100 }, selfTower.pos)\n        guidePos = TensorCore.getPosInDirection({ x = 100, y = 0, z = 100 }, heading, 8)\n    end\nelseif M.SelfPos == \"D1\" or M.SelfPos == \"D2\" then\n    if table.size(M.M11S.Meteor3Info.Spell46167) == 2 then\n        local D1Take, D2Take = M.M11S.Meteor3Info.FindDir(M.M11S.Meteor3Info.Spell46167[1], M.M11S.Meteor3Info.Spell46167[2])\n        if M.SelfPos == \"D1\" then\n            selfTower = D1Take\n        else\n            selfTower = D2Take\n        end\n        local heading = TensorCore.getHeadingToTarget({ x = 100, y = 0, z = 100 }, selfTower.pos)\n        guidePos = TensorCore.getPosInDirection({ x = 100, y = 0, z = 100 }, heading, 8)\n    end\nelse\n    if table.size(M.M11S.Meteor3Info.Spell46167) == 2 and (not table.contains(M.M11S.Meteor3Info.Marked, M.GetPlayer().id)) then\n        local t1, t2 = M.M11S.Meteor3Info.FindDir(M.M11S.Meteor3Info.Spell46167[1], M.M11S.Meteor3Info.Spell46167[2])\n        local selfIdx = M.IndexOf(M.M11S.Meteor3Info.JobOrder, M.SelfPos)\n        local otherJob\n        for job, ent in pairs(M.Party) do\n            if ent.id ~= M.GetPlayer().id and table.contains(M.M11S.Meteor3Info.JobOrder, job) and (not table.contains(M.M11S.Meteor3Info.Marked, ent.id)) then\n                otherJob = job\n                break\n            end\n        end\n        local otherIndex = M.IndexOf(M.M11S.Meteor3Info.JobOrder, otherJob)\n        if selfIdx > otherIndex then\n            selfTower = t2\n        else\n            selfTower = t1\n        end\n        local heading = TensorCore.getHeadingToTarget({ x = 100, y = 0, z = 100 }, selfTower.pos)\n        guidePos = TensorCore.getPosInDirection({ x = 100, y = 0, z = 100 }, heading, 14)\n    end\nend\n\nif guidePos ~= nil then\n    M.DirectTo(guidePos.x, guidePos.z, 5000)\nend\nself.used = true",
						conditions = 
						{
						...
						gVar = "ACR_TensorWeeb3_CD",
						name = "陨石狂奔-踩塔",
						uuid = "553e3aae-7c3f-d5bc-a66d-f8217a5f5a87",
						version = 2.1,
					},
					inheritedIndex = 10,
				},
				
				{
					...
					{
						aType = "Lua",
						actionLua = "MuAiGuide.M11S.Meteor3Info.LastFrame = eventArgs.spellID\nself.used = true",
						conditions = 
						{
							...
							{
								"96650570-3677-0c1f-832a-cff4a857401c",
								true,
							},
						},
						gVar = "ACR_RikuMNK3_CD",
						name = "陨石狂奔-4or2向火",
						uuid = "22e8251c-e03d-e73f-bb49-2496365ca4d4",
						version = 2.1,
					},
					inheritedIndex = 11,
				},
			...
			conditions = 
			{
				...
				
				{
					data = 
					{
						...
						conditionLua = "return MuAiGuide.Config.Main.M11SExDraw",
						name = "画图设置",
						uuid = "d7d686ef-d64b-a32c-b12d-cd6ee9164227",
						version = 3,
					},
					inheritedIndex = 2,
				},
				
				{
					data = 
					{
						...
						eventSpellID = 46102,
						name = "46102-历战之兵武",
						uuid = "a3b7139c-b3a9-3e6b-8175-830f52c3a921",
						version = 3,
					},
				},
				
				{
					data = 
					{
						...
						eventSpellID = 46103,
						name = "46103-铸兵突袭",
						uuid = "dd416fb1-1595-99e6-ba90-08b042b7231a",
						version = 3,
					},
					inheritedIndex = 7,
				},
				
				{
					data = 
					{
						...
						eventSpellID = 46112,
						name = "46112-爆炸(劈刀)",
						uuid = "16bb9852-efcf-a977-ac2c-ffde0662d2da",
						version = 3,
					},
				},
				
				{
					data = 
					{
						...
						eventArgType = 2,
						name = "46115-镰刀||46115-斧子",
						spellIDList = 
						{
							46115,
							46114,
						},
						uuid = "599e9feb-a4c2-9634-9533-e469c9016c28",
						version = 3,
					},
					inheritedIndex = 7,
				},
				
				{
					data = 
					{
						...
						eventSpellID = 46127,
						name = "46127-兽焰连尾击",
						uuid = "44282433-3925-c3d9-ac41-44068c5c125b",
						version = 3,
					},
					inheritedIndex = 9,
				},
				
				{
					data = 
					{
						...
						eventSpellID = 46130,
						name = "46130-星轨链",
						uuid = "0ea03ec8-3099-bcd7-8911-ea92a548c6e8",
						version = 3,
					},
					inheritedIndex = 8,
				},
				...
				
				{
					data = 
					{
						...
						eventSpellID = 46144,
						name = "46144-王者陨石",
						uuid = "fcd424a1-fa9c-b941-b3d4-a177a774c78d",
						version = 3,
					},
					inheritedIndex = 9,
				},
				
				{
					data = 
					{
						...
						eventSpellID = 46143,
						name = "46143-绝命分断击",
						uuid = "cdc353e5-0e50-2da4-b26b-cba68c1fd602",
						version = 3,
					},
					inheritedIndex = 12,
				},
				...
				
				{
					data = 
					{
						...
						uuid = "e294ba3c-78ed-ebf7-8e0b-1d5ff7ed4f23",
						version = 3,
					},
					inheritedIndex = 13,
				},
				
				{
					data = 
					{
						...
						eventSpellID = 46162,
						name = "46162-陨石狂奔",
						uuid = "1eb74c66-cda9-4f74-9531-d17a7c8c6de6",
						version = 3,
					},
					inheritedIndex = 13,
				},
				
				{
					data = 
					{
						...
						eventSpellID = 46163,
						name = "46163-遮天陨石",
						uuid = "5467f634-a82b-69f1-b31e-ad5f89024dbe",
						version = 3,
					},
					inheritedIndex = 14,
				},
				...
				
				{
					data = 
					{
						...
						eventArgOptionType = 3,
						eventArgType = 2,
						name = "46170-四向|47037-双向",
						spellIDList = 
						{
							46170,
							47037,
						},
						uuid = "96650570-3677-0c1f-832a-cff4a857401c",
						version = 3,
					},
					inheritedIndex = 15,
				},
				
				{
					data = 
					{
						...
						eventSpellID = 47085,
						name = "47085-历战之极武",
						uuid = "9881615b-f494-85ff-98ba-4f68742f42c7",
						version = 3,
					},
					inheritedIndex = 16,
				},
				
				{
					data = 
					{
						...
						conditionLua = "return MuAiGuide.M11S.CurrentState < MuAiGuide.M11S.State.Weapon1_Start",
						name = "三连兵器1-未开始",
						uuid = "1e73bf37-8a27-da19-b9a3-7783f9117aa6",
						version = 3,
					},
					inheritedIndex = 14,
				},
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return MuAiGuide.M11S.CurrentState >= MuAiGuide.M11S.State.Weapon1_End\n   and MuAiGuide.M11S.CurrentState < MuAiGuide.M11S.State.Weapon2_Start",
						name = "三连兵器2-未开始",
						uuid = "0db5b078-547f-e6c2-a183-5441c51345a0",
						version = 3,
					},
					inheritedIndex = 12,
				},
				
				{
					data = 
					{
						...
						conditionLua = "return MuAiGuide.M11S.CurrentState < MuAiGuide.M11S.State.Meteor2_Start",
						name = "王者陨石-未开始",
						uuid = "d0d48b0d-93e0-d389-8d89-e243205e328d",
						version = 3,
					},
					inheritedIndex = 14,
				},
		...
		data = 
		{
			actions = 
			{
				...
				
				{
					...
					{
						aType = "Lua",
						actionLua = "MuAiGuide.M11SMapType = 0\nMuAiGuide.M11S.CurrentState = MuAiGuide.M11S.State.Meteor2_end\nself.used = true",
						conditions = 
						{
							...
							{
								"4499f3d4-9d21-ea34-9204-41201ee0ce19",
								true,
							},
						},
						gVar = "ACR_RikuMNK3_CD",
			...
			conditions = 
			{
				...
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return MuAiGuide.M11S.CurrentState >= MuAiGuide.M11S.State.Meteor2_Start and \nMuAiGuide.M11S.CurrentState < MuAiGuide.M11S.State.Meteor2_end",
						name = "王者陨石阶段-未结束",
						uuid = "4499f3d4-9d21-ea34-9204-41201ee0ce19",
						version = 3,
					},
				},
			},
	...
	
	{
		data = 
		{
			...
			name = "-------- 已弃用 --------",
			uuid = "89c762b0-be14-cb99-bfdb-7f34e2e85d93",
			version = 2,
		},
		inheritedIndex = 36,
	},
