		...
		data = 
		{
			...
			conditions = 
			{
				...
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return MuAiGuide.M12S.P2Info.linkEnt.type == MuAiGuide.M12S.DataEnum.Cone",
						name = "扇形点名",
