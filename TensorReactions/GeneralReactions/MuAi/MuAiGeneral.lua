		...
		data = 
		{
			...
			conditions = 
			{
				...
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return MuAiGuide.M11S.CurrentState < MuAiGuide.M11S.State.Meteor2_end",
						name = "王者陨石阶段-未结束",
