...
G.OnAOECreate = function(aoeInfo)
    ...
    elseif aoeInfo.aoeID == 46573 or aoeInfo.aoeID == 46574 then
        mmd.Timer46574 = Now()
    elseif aoeInfo.aoeID == 46705 then
        if mmd.CurrentState > mmd.State.Boss2_P4_Start and getCfg().MerchantDraw then
        ...
        if mmd.CurrentState >= mmd.State.Boss2_P4_Start and mmd.CurrentState < mmd.State.Boss2_P4_Linked then
            changeState(mmd.State.Boss2_P4_Linked)
        end
